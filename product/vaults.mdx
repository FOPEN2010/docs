...
Vaults are the core investment units within RondSync, providing structured access to yield strategies through isolated capital allocation.
Each Vault represents a distinct strategy with its own parameters,
risk profile, and return characteristics.
