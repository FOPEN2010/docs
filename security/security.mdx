---
title: "Security"
description: "RondoSync is designed with a multi-layered security architecture to protect user funds and system integrity."
icon: "shield-check"
---
...
No system is risk-free, but RondoSync aims to reduce risk
...
RondoSync relies on distributed infrastructure components.
...
RondoSync security is based on:
