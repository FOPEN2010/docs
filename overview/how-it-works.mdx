...
Capital is deployed through the strategy engine (OctoCapitalCore).

- Strategies are executed across various venues  
- Includes centralized and decentralized environments  
- Designed to optimize execution and risk-adjusted returns  
...
- Based on Vault share (unit-based system)  
